...
% %utilizará o metodo Newton-Raphson para a solução do problema o método
% %segue a equação: X_n+1 = X_n - f(X_n)/f'(X_n)
% 
...
%          %a função dif assumirá f(Vn)/f'(Vn) temos portanto que: Vn+1 = Vn
%          %- dif => NEWTON-RAPSON!!
%          
